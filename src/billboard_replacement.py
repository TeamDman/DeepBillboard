...
#%%
# noinspection PyShadowingNames
def apply_image_to_billboard(source_image, labeled_source_image, decal_image, display_steps=False):
    ...
    if display_steps:
        ...
        display(padded_labeled_source_image)
        display(binary_image)
        display(outlined_image)
    ...
    return output_image_borderless
...
output_image = apply_image_to_billboard(
    source_image,
    labeled_image,
    decal_image,
    display_steps=False
